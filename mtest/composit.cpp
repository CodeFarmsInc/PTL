...
pattern Composite<Picture,Graphic,1> comp;
pattern Collection<Root,Graphic,0>   coll;

Root::~Root(){
    pattern_iterator_coll itColl;
    Graphic *pGraphic;
